  ...
  return (
    <aside className="w-full md:w-64 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800/80 rounded-2xl p-4 shadow-xs space-y-4 shrink-0 text-xs">
      ...
      <div className="flex items-center gap-3 p-3 bg-neutral-50 dark:bg-neutral-950 rounded-xl border border-neutral-100 dark:border-neutral-800">
        <div className="w-11 h-11 rounded-full bg-emerald-700 text-white font-black text-sm flex items-center justify-center shadow-sm shrink-0">
          RS
        </div>
        <div className="min-w-0">
          <h4 className="font-extrabold text-neutral-900 dark:text-white truncate text-xs">Rahul Sharma</h4>
          <p className="text-[11px] text-neutral-500 dark:text-neutral-400 font-medium truncate">+91 98765 43210</p>
