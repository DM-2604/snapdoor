      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-primary rounded-xl p-6 md:p-8 flex items-center justify-between text-white relative overflow-hidden h-40">
          <div className="z-10 relative">
            ...
            <button suppressHydrationWarning className="bg-white dark:bg-neutral-900 text-primary text-xs font-bold px-4 py-2 rounded-md shadow-sm hover:bg-neutral-50 dark:hover:bg-neutral-950 transition-colors">
              Order Now
            </button>
          </div>
          {/* Graphic placeholder */}
        ...
        <div className="bg-yellow-100 rounded-xl p-6 md:p-8 flex items-center justify-between text-neutral-800 dark:text-neutral-100 relative overflow-hidden h-40">
          <div className="z-10 relative">
            ...
            <button suppressHydrationWarning className="bg-neutral-900 text-white text-xs font-bold px-4 py-2 rounded-md shadow-sm hover:bg-black transition-colors">
              Order Now
            </button>
          </div>
          {/* Graphic placeholder */}
        ...
        <div className="bg-blue-800 rounded-xl p-6 md:p-8 flex items-center justify-between text-white relative overflow-hidden h-40">
          <div className="z-10 relative">
            ...
            <button suppressHydrationWarning className="bg-blue-600 text-white border border-blue-400 text-xs font-bold px-4 py-2 rounded-md shadow-sm hover:bg-blue-500 transition-colors">
              Shop Now
            </button>
          </div>
          {/* Graphic placeholder */}
